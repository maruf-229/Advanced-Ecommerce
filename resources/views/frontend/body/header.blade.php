            ...
            <div class="header-top-inner">
                        ...
                        <li>
                            ...
                            @auth
                                <a href="{{ route('dashboard') }}"><i class="icon fa fa-user"></i>
                                    @if(session()->get('language') == 'bangla')ব্যাবহারকারীর বিস্তারিত @else  User Profile @endif
                                </a>
                            @else
                                <a href="{{ route('login') }}"><i class="icon fa fa-lock"></i>
                                    @if(session()->get('language') == 'bangla')লগইন/রেজিস্টার করুন @else Login/Register @endif
                                </a>
                            @endauth
                ...
                <div class="cnt-block">
                    <ul class="list-unstyled list-inline">
                        ...
                        @if(session()->get('language') == 'bangla')ভাষা @else Language @endif
